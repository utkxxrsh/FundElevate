...
<div className="mt-[20px] flex flex-col gap-4">
  {donators.length>0 ? donators.map((item,index)=>(
    <div key={`${item.donator}-${index}`} className="flex
    justify-between iitems-center gap-4">
      <p className="font-epilogue font-normal text-[16px]
      text-[#b2b3bd] leading-[26px] break-all">{index+1}.{item.donator}</p>
       <p className="font-epilogue font-normal text-[16px]
      text-[#808191] leading-[26px] break-all">{item.donation}</p>
      </div>

  )):(
    <p className=" font-epilogue font-normal text-[12px] text-[#808191] leading-[26px] text-justify">No Donators yet!! Be the First One</p>
  )}
      ...
      <div className="flex-1">
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
            ...
            <div className="mt-[20px] p-4 bg-[#13131a] rounded-[10px]">
              ...
              text-white">Fund for a Good Cause</h4>
              <p className="mt-[20px] font-epilogue font-normal leading-[22px] text-[#808191] ">Support for a Cause and help the world</p>
            </div>
